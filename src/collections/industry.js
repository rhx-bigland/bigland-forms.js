...
const company_industry_collection = Object.keys(company_industry).map(
    key => company_industry[key] );

export {
    company_industry as map,
    company_industry_collection as collection
};
